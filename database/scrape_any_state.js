...
const STATE_CONFIG = {
    name: 'Alabama',  // Currently scraping Alabama
    websites: [
        { url: 'https://www.gearboxrentals.com/', name: 'Gearbox Adventure Rentals' },
        { url: 'https://www.storytelleroverland.com/', name: 'Storyteller Overland' },
        { url: 'https://vulcancoach.com/', name: 'Vulcan Coach' }
    ]
};

// Additional city coordinates for better geocoding fallbacks
// Alabama major cities for geocoding
const STATE_CITY_COORDINATES = {
    ...
    'auburn': { lat: 32.6010, lng: -85.4808 },
